...
class TLSConnection(TLSRecordLayer):
    ...
    def handshakeClientAnonymous(self, session=None, settings=None, 
        ...
        @type isAsync: bool
        @param isAsync: If False, this function will block until the
        ...
        @return: If 'isAsync' is True, a generator object will be
        returned.
    ...
    def handshakeClientCert(self, certChain=None, privateKey=None,
        ...
        # it is waiting to read.
        #
        # If 'isAsync' is True, the generator is returned to the caller,
        # otherwise it is executed to completion here.                        
        if isAsync:
            return handshaker
        for result in handshaker:
